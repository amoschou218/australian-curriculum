...
<table>
  <tr>
    <td colspan="4">Science as a human endeavour</td>
  </tr>
  <tr>
    <td colspan="4">
  ...
  <tr>
    <td colspan="2">Nature and development of science</td>
    <td colspan="2">Use and influence of science</td>
  </tr>
  <tr>
    <td colspan="2">
  ...
  <tr><td colspan="4">Content descriptions</td></tr>
  <tr>
    <td>Years 7 and 8</td>
  ...
  <tr>
    <td>
      <ul>
        <li>(H1) explain how new evidence or different perspectives can lead to changes in scientific knowledge</li>
        <li>(H2) investigate how cultural perspectives and world views influence the development of scientific knowledge</li>
      </ul>
    </td>
    <td>
      <ul>
    ...
    <td>
      <ul>
        <li>(H3) examine how proposed scientific responses to contemporary issues may impact on society and explore ethical, environmental, social and economic considerations</li>
        <li>(H4) explore the role of science communication in informing individual viewpoints and community policies and regulations</li>
      </ul>
    </td>
    <td>
      <ul>
  ...
  <tr><td colspan="4">Achievement standards</td></tr>
  <tr>
    <td>
      <p>(7H12) Students identify the factors that can influence development of and lead to changes in scientific knowledge.</p>
      <p>(8H12) Students analyse how different factors influence development of and lead to changes in scientific knowledge.</p>
    </td>
    <td>
      <p>(9H12) Students explain the role of publication and peer review in the development of scientific knowledge and explain the relationship between science, technologies and engineering.</p>
      <p>(10H12) Students analyse the importance of publication and peer review in the development of scientific knowledge and analyse the relationship between science, technologies and engineering.</p>
    </td>
    <td>
      <p>(7H3) They explain how scientific responses are developed and can impact society. (7H4) They explain the role of science communication in shaping viewpoints, policies and regulations.</p>
      <p>(8H3) They analyse the key considerations that inform scientific responses and how these responses impact society. (8H4) They analyse the importance of science communication in shaping viewpoints, policies and regulations.</p>
    </td>
    <td>
      <p>(9H34) They analyse the different ways in which science and society are interconnected.</p>
      <p>(10H34) They analyse the key factors that influence interactions between science and society.</p>
    </td>
  </tr>
</table>
